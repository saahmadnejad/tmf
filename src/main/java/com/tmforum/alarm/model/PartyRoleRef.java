...
public class PartyRoleRef implements PartyRefOrPartyRoleRef {
  ...
  public PartyRoleRef atBaseType(String atBaseType) {
  ...
  public PartyRoleRef atSchemaLocation(String atSchemaLocation) {
  ...
  public PartyRoleRef atReferredType(String atReferredType) {
