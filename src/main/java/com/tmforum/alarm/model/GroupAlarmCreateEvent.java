...
import com.tmforum.alarm.model.GroupAlarmCreateEventPayload;
...
public class GroupAlarmCreateEvent {
  ...
  private GroupAlarmCreateEventPayload event;

  public GroupAlarmCreateEvent() {
    super();
  }
   ...
   */
  public GroupAlarmCreateEvent(String atType) {
    this.atType = atType;
  }

  public GroupAlarmCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public GroupAlarmCreateEvent atBaseType(String atBaseType) {
  ...
  public GroupAlarmCreateEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public GroupAlarmCreateEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public GroupAlarmCreateEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GroupAlarmCreateEvent correlationId(String correlationId) {
  ...
  public GroupAlarmCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public GroupAlarmCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GroupAlarmCreateEvent description(String description) {
  ...
  public GroupAlarmCreateEvent priority(String priority) {
  ...
  public GroupAlarmCreateEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public GroupAlarmCreateEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public GroupAlarmCreateEvent reportingSystem(EntityRef reportingSystem) {
  ...
  public GroupAlarmCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public GroupAlarmCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public GroupAlarmCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public GroupAlarmCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public GroupAlarmCreateEvent eventId(String eventId) {
  ...
  public GroupAlarmCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  public GroupAlarmCreateEvent eventType(String eventType) {
  ...
  public GroupAlarmCreateEvent event(GroupAlarmCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public GroupAlarmCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(GroupAlarmCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    GroupAlarmCreateEvent groupAlarmCreateEvent = (GroupAlarmCreateEvent) o;
    return Objects.equals(this.atType, groupAlarmCreateEvent.atType) &&
        Objects.equals(this.atBaseType, groupAlarmCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, groupAlarmCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, groupAlarmCreateEvent.href) &&
        Objects.equals(this.id, groupAlarmCreateEvent.id) &&
        Objects.equals(this.correlationId, groupAlarmCreateEvent.correlationId) &&
        Objects.equals(this.domain, groupAlarmCreateEvent.domain) &&
        Objects.equals(this.title, groupAlarmCreateEvent.title) &&
        Objects.equals(this.description, groupAlarmCreateEvent.description) &&
        Objects.equals(this.priority, groupAlarmCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, groupAlarmCreateEvent.timeOccurred) &&
        Objects.equals(this.source, groupAlarmCreateEvent.source) &&
        Objects.equals(this.reportingSystem, groupAlarmCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, groupAlarmCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, groupAlarmCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, groupAlarmCreateEvent.eventId) &&
        Objects.equals(this.eventTime, groupAlarmCreateEvent.eventTime) &&
        Objects.equals(this.eventType, groupAlarmCreateEvent.eventType) &&
        Objects.equals(this.event, groupAlarmCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupAlarmCreateEvent {\n");
