...
public class CommentMVO {
   ...
   */
  public CommentMVO(String atType) {
    this.atType = atType;
  }

  public CommentMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CommentMVO atBaseType(String atBaseType) {
  ...
  public CommentMVO atSchemaLocation(String atSchemaLocation) {
  ...
  public CommentMVO userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public CommentMVO systemId(String systemId) {
  ...
  public CommentMVO time(OffsetDateTime time) {
    this.time = time;
    return this;
  }
  ...
  public CommentMVO comment(String comment) {
  ...
  public boolean equals(Object o) {
    ...
    CommentMVO commentMVO = (CommentMVO) o;
    return Objects.equals(this.atType, commentMVO.atType) &&
        Objects.equals(this.atBaseType, commentMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, commentMVO.atSchemaLocation) &&
        Objects.equals(this.userId, commentMVO.userId) &&
        Objects.equals(this.systemId, commentMVO.systemId) &&
        Objects.equals(this.time, commentMVO.time) &&
        Objects.equals(this.comment, commentMVO.comment);
  }
