...
import com.tmforum.alarm.model.UnAckAlarmCreateEventPayload;
...
public class UnAckAlarmCreateEvent {
  ...
  private UnAckAlarmCreateEventPayload event;

  public UnAckAlarmCreateEvent() {
    super();
  }
   ...
   */
  public UnAckAlarmCreateEvent(String atType) {
    this.atType = atType;
  }

  public UnAckAlarmCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public UnAckAlarmCreateEvent atBaseType(String atBaseType) {
  ...
  public UnAckAlarmCreateEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public UnAckAlarmCreateEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public UnAckAlarmCreateEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UnAckAlarmCreateEvent correlationId(String correlationId) {
  ...
  public UnAckAlarmCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public UnAckAlarmCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public UnAckAlarmCreateEvent description(String description) {
  ...
  public UnAckAlarmCreateEvent priority(String priority) {
  ...
  public UnAckAlarmCreateEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public UnAckAlarmCreateEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public UnAckAlarmCreateEvent reportingSystem(EntityRef reportingSystem) {
  ...
  public UnAckAlarmCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public UnAckAlarmCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public UnAckAlarmCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public UnAckAlarmCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public UnAckAlarmCreateEvent eventId(String eventId) {
  ...
  public UnAckAlarmCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  public UnAckAlarmCreateEvent eventType(String eventType) {
  ...
  public UnAckAlarmCreateEvent event(UnAckAlarmCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public UnAckAlarmCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(UnAckAlarmCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    UnAckAlarmCreateEvent unAckAlarmCreateEvent = (UnAckAlarmCreateEvent) o;
    return Objects.equals(this.atType, unAckAlarmCreateEvent.atType) &&
        Objects.equals(this.atBaseType, unAckAlarmCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, unAckAlarmCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, unAckAlarmCreateEvent.href) &&
        Objects.equals(this.id, unAckAlarmCreateEvent.id) &&
        Objects.equals(this.correlationId, unAckAlarmCreateEvent.correlationId) &&
        Objects.equals(this.domain, unAckAlarmCreateEvent.domain) &&
        Objects.equals(this.title, unAckAlarmCreateEvent.title) &&
        Objects.equals(this.description, unAckAlarmCreateEvent.description) &&
        Objects.equals(this.priority, unAckAlarmCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, unAckAlarmCreateEvent.timeOccurred) &&
        Objects.equals(this.source, unAckAlarmCreateEvent.source) &&
        Objects.equals(this.reportingSystem, unAckAlarmCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, unAckAlarmCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, unAckAlarmCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, unAckAlarmCreateEvent.eventId) &&
        Objects.equals(this.eventTime, unAckAlarmCreateEvent.eventTime) &&
        Objects.equals(this.eventType, unAckAlarmCreateEvent.eventType) &&
        Objects.equals(this.event, unAckAlarmCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnAckAlarmCreateEvent {\n");
