...
import com.tmforum.alarm.model.ClearAlarmCreateEventPayload;
...
public class ClearAlarmCreateEvent {
  ...
  private ClearAlarmCreateEventPayload event;

  public ClearAlarmCreateEvent() {
    super();
  }
   ...
   */
  public ClearAlarmCreateEvent(String atType) {
    this.atType = atType;
  }

  public ClearAlarmCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ClearAlarmCreateEvent atBaseType(String atBaseType) {
  ...
  public ClearAlarmCreateEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public ClearAlarmCreateEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public ClearAlarmCreateEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ClearAlarmCreateEvent correlationId(String correlationId) {
  ...
  public ClearAlarmCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ClearAlarmCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ClearAlarmCreateEvent description(String description) {
  ...
  public ClearAlarmCreateEvent priority(String priority) {
  ...
  public ClearAlarmCreateEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public ClearAlarmCreateEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public ClearAlarmCreateEvent reportingSystem(EntityRef reportingSystem) {
  ...
  public ClearAlarmCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ClearAlarmCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public ClearAlarmCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public ClearAlarmCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public ClearAlarmCreateEvent eventId(String eventId) {
  ...
  public ClearAlarmCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  public ClearAlarmCreateEvent eventType(String eventType) {
  ...
  public ClearAlarmCreateEvent event(ClearAlarmCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public ClearAlarmCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(ClearAlarmCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClearAlarmCreateEvent clearAlarmCreateEvent = (ClearAlarmCreateEvent) o;
    return Objects.equals(this.atType, clearAlarmCreateEvent.atType) &&
        Objects.equals(this.atBaseType, clearAlarmCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, clearAlarmCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, clearAlarmCreateEvent.href) &&
        Objects.equals(this.id, clearAlarmCreateEvent.id) &&
        Objects.equals(this.correlationId, clearAlarmCreateEvent.correlationId) &&
        Objects.equals(this.domain, clearAlarmCreateEvent.domain) &&
        Objects.equals(this.title, clearAlarmCreateEvent.title) &&
        Objects.equals(this.description, clearAlarmCreateEvent.description) &&
        Objects.equals(this.priority, clearAlarmCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, clearAlarmCreateEvent.timeOccurred) &&
        Objects.equals(this.source, clearAlarmCreateEvent.source) &&
        Objects.equals(this.reportingSystem, clearAlarmCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, clearAlarmCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, clearAlarmCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, clearAlarmCreateEvent.eventId) &&
        Objects.equals(this.eventTime, clearAlarmCreateEvent.eventTime) &&
        Objects.equals(this.eventType, clearAlarmCreateEvent.eventType) &&
        Objects.equals(this.event, clearAlarmCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClearAlarmCreateEvent {\n");
