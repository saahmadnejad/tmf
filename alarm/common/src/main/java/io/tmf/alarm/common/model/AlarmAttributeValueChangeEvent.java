...
import com.tmforum.alarm.model.AlarmAttributeValueChangeEventPayload;
...
public class AlarmAttributeValueChangeEvent {
  ...
  private AlarmAttributeValueChangeEventPayload event;

  public AlarmAttributeValueChangeEvent() {
    super();
  }
   ...
   */
  public AlarmAttributeValueChangeEvent(String atType) {
    this.atType = atType;
  }

  public AlarmAttributeValueChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AlarmAttributeValueChangeEvent atBaseType(String atBaseType) {
  ...
  public AlarmAttributeValueChangeEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public AlarmAttributeValueChangeEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public AlarmAttributeValueChangeEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AlarmAttributeValueChangeEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public AlarmAttributeValueChangeEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public AlarmAttributeValueChangeEvent reportingSystem(EntityRef reportingSystem) {
  ...
  public AlarmAttributeValueChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public AlarmAttributeValueChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public AlarmAttributeValueChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public AlarmAttributeValueChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, alarmAttributeValueChangeEvent.atType) &&
        Objects.equals(this.atBaseType, alarmAttributeValueChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, alarmAttributeValueChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, alarmAttributeValueChangeEvent.href) &&
        Objects.equals(this.id, alarmAttributeValueChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, alarmAttributeValueChangeEvent.timeOccurred) &&
        Objects.equals(this.source, alarmAttributeValueChangeEvent.source) &&
        Objects.equals(this.reportingSystem, alarmAttributeValueChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, alarmAttributeValueChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, alarmAttributeValueChangeEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, alarmAttributeValueChangeEvent.eventId) &&
