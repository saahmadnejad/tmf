...
import io.tmf.alarm.common.model.AlarmedObjectRef;
import io.tmf.alarm.common.model.Comment;
import io.tmf.alarm.common.model.CrossedThresholdInformation;
import io.tmf.alarm.common.model.PerceivedSeverity;
import io.tmf.alarm.common.model.RelatedPlace;
import io.tmf.alarm.common.model.ServiceRef;
...
public class Alarm implements AlarmRefOrValue {
  ...
  @Valid
  private List<RelatedPlace> place = new ArrayList<>();
  ...
  public Alarm affectedService(List<@Valid ServiceRef> affectedService) {
  ...
  public Alarm place(List<RelatedPlace> place) {
    this.place = place;
    return this;
  }

  public Alarm addPlaceItem(RelatedPlace placeItem) {
    if (this.place == null) {
