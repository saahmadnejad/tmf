...
import com.tmforum.alarm.model.AlarmRefMVO;
import com.tmforum.alarm.model.AlarmType;
import com.tmforum.alarm.model.AlarmedObjectRefMVO;
import com.tmforum.alarm.model.CommentMVO;
import com.tmforum.alarm.model.CrossedThresholdInformationMVO;
import com.tmforum.alarm.model.PerceivedSeverity;
import com.tmforum.alarm.model.RelatedPlaceMVO;
import com.tmforum.alarm.model.ServiceRefMVO;
...
public class AlarmMVO {
  ...
  private AlarmedObjectRefMVO alarmedObject;
  ...
  @Valid
  private List<@Valid ServiceRefMVO> affectedService = new ArrayList<>();
  ...
  @Valid
  private List<CommentMVO> comment = new ArrayList<>();

  @Valid
  private List<@Valid AlarmRefMVO> correlatedAlarm = new ArrayList<>();

  private CrossedThresholdInformationMVO crossedThresholdInformation;

  private Boolean isRootCause;

  @Valid
  private List<@Valid AlarmRefMVO> parentAlarm = new ArrayList<>();
  ...
  @Valid
  private List<RelatedPlaceMVO> place = new ArrayList<>();
   ...
   */
  public AlarmMVO(String atType) {
    this.atType = atType;
  }

  public AlarmMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AlarmMVO atBaseType(String atBaseType) {
  ...
  public AlarmMVO atSchemaLocation(String atSchemaLocation) {
  ...
  public AlarmMVO href(String href) {
    this.href = href;
    return this;
  }
  ...
  public AlarmMVO externalAlarmId(String externalAlarmId) {
  ...
  public AlarmMVO state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public AlarmMVO alarmType(AlarmType alarmType) {
  ...
  public AlarmMVO perceivedSeverity(PerceivedSeverity perceivedSeverity) {
  ...
  public AlarmMVO probableCause(String probableCause) {
  ...
  public AlarmMVO specificProblem(String specificProblem) {
  ...
  public AlarmMVO alarmedObjectType(String alarmedObjectType) {
  ...
  public AlarmMVO alarmedObject(AlarmedObjectRefMVO alarmedObject) {
  ...
  public AlarmedObjectRefMVO getAlarmedObject() {
    return alarmedObject;
  }

  public void setAlarmedObject(AlarmedObjectRefMVO alarmedObject) {
    this.alarmedObject = alarmedObject;
  }

  public AlarmMVO reportingSystemId(String reportingSystemId) {
  ...
  public AlarmMVO alarmDetails(String alarmDetails) {
  ...
  public AlarmMVO alarmChangedTime(OffsetDateTime alarmChangedTime) {
  ...
  public AlarmMVO alarmClearedTime(OffsetDateTime alarmClearedTime) {
  ...
  public AlarmMVO alarmReportingTime(OffsetDateTime alarmReportingTime) {
  ...
  public AlarmMVO ackState(AckStateEnum ackState) {
  ...
  public AlarmMVO ackSystemId(String ackSystemId) {
  ...
  public AlarmMVO ackUserId(String ackUserId) {
  ...
  public AlarmMVO affectedService(List<@Valid ServiceRefMVO> affectedService) {
    this.affectedService = affectedService;
    return this;
  }

  public AlarmMVO addAffectedServiceItem(ServiceRefMVO affectedServiceItem) {
  ...
  public List<@Valid ServiceRefMVO> getAffectedService() {
    return affectedService;
  }

  public void setAffectedService(List<@Valid ServiceRefMVO> affectedService) {
    this.affectedService = affectedService;
  }

  public AlarmMVO alarmEscalation(Boolean alarmEscalation) {
  ...
  public AlarmMVO clearSystemId(String clearSystemId) {
  ...
  public AlarmMVO clearUserId(String clearUserId) {
  ...
  public AlarmMVO comment(List<CommentMVO> comment) {
    this.comment = comment;
    return this;
  }

  public AlarmMVO addCommentItem(CommentMVO commentItem) {
  ...
  public List<CommentMVO> getComment() {
    return comment;
  }

  public void setComment(List<CommentMVO> comment) {
    this.comment = comment;
  }

  public AlarmMVO correlatedAlarm(List<@Valid AlarmRefMVO> correlatedAlarm) {
    this.correlatedAlarm = correlatedAlarm;
    return this;
  }

  public AlarmMVO addCorrelatedAlarmItem(AlarmRefMVO correlatedAlarmItem) {
  ...
  public List<@Valid AlarmRefMVO> getCorrelatedAlarm() {
    return correlatedAlarm;
  }

  public void setCorrelatedAlarm(List<@Valid AlarmRefMVO> correlatedAlarm) {
    this.correlatedAlarm = correlatedAlarm;
  }

  public AlarmMVO crossedThresholdInformation(CrossedThresholdInformationMVO crossedThresholdInformation) {
  ...
  public CrossedThresholdInformationMVO getCrossedThresholdInformation() {
    return crossedThresholdInformation;
  }

  public void setCrossedThresholdInformation(CrossedThresholdInformationMVO crossedThresholdInformation) {
    this.crossedThresholdInformation = crossedThresholdInformation;
  }

  public AlarmMVO isRootCause(Boolean isRootCause) {
  ...
  public AlarmMVO parentAlarm(List<@Valid AlarmRefMVO> parentAlarm) {
    this.parentAlarm = parentAlarm;
    return this;
  }

  public AlarmMVO addParentAlarmItem(AlarmRefMVO parentAlarmItem) {
  ...
  public List<@Valid AlarmRefMVO> getParentAlarm() {
    return parentAlarm;
  }

  public void setParentAlarm(List<@Valid AlarmRefMVO> parentAlarm) {
    this.parentAlarm = parentAlarm;
  }

  public AlarmMVO plannedOutageIndicator(PlannedOutageIndicatorEnum plannedOutageIndicator) {
  ...
  public AlarmMVO proposedRepairedActions(String proposedRepairedActions) {
  ...
  public AlarmMVO serviceAffecting(Boolean serviceAffecting) {
  ...
  public AlarmMVO place(List<RelatedPlaceMVO> place) {
    this.place = place;
    return this;
  }

  public AlarmMVO addPlaceItem(RelatedPlaceMVO placeItem) {
    if (this.place == null) {
  ...
  @JsonProperty("place")
  public List<RelatedPlaceMVO> getPlace() {
    return place;
  }

  public void setPlace(List<RelatedPlaceMVO> place) {
    this.place = place;
  }
  ...
  public boolean equals(Object o) {
    ...
    AlarmMVO alarmMVO = (AlarmMVO) o;
    return Objects.equals(this.atType, alarmMVO.atType) &&
        Objects.equals(this.atBaseType, alarmMVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, alarmMVO.atSchemaLocation) &&
        Objects.equals(this.href, alarmMVO.href) &&
        Objects.equals(this.id, alarmMVO.id) &&
        Objects.equals(this.externalAlarmId, alarmMVO.externalAlarmId) &&
        Objects.equals(this.state, alarmMVO.state) &&
        Objects.equals(this.alarmType, alarmMVO.alarmType) &&
        Objects.equals(this.perceivedSeverity, alarmMVO.perceivedSeverity) &&
        Objects.equals(this.probableCause, alarmMVO.probableCause) &&
        Objects.equals(this.specificProblem, alarmMVO.specificProblem) &&
        Objects.equals(this.alarmedObjectType, alarmMVO.alarmedObjectType) &&
        Objects.equals(this.alarmedObject, alarmMVO.alarmedObject) &&
        Objects.equals(this.reportingSystemId, alarmMVO.reportingSystemId) &&
        Objects.equals(this.alarmDetails, alarmMVO.alarmDetails) &&
        Objects.equals(this.alarmChangedTime, alarmMVO.alarmChangedTime) &&
        Objects.equals(this.alarmClearedTime, alarmMVO.alarmClearedTime) &&
        Objects.equals(this.alarmReportingTime, alarmMVO.alarmReportingTime) &&
        Objects.equals(this.ackState, alarmMVO.ackState) &&
        Objects.equals(this.ackSystemId, alarmMVO.ackSystemId) &&
        Objects.equals(this.ackUserId, alarmMVO.ackUserId) &&
        Objects.equals(this.affectedService, alarmMVO.affectedService) &&
        Objects.equals(this.alarmEscalation, alarmMVO.alarmEscalation) &&
        Objects.equals(this.clearSystemId, alarmMVO.clearSystemId) &&
        Objects.equals(this.clearUserId, alarmMVO.clearUserId) &&
        Objects.equals(this.comment, alarmMVO.comment) &&
        Objects.equals(this.correlatedAlarm, alarmMVO.correlatedAlarm) &&
        Objects.equals(this.crossedThresholdInformation, alarmMVO.crossedThresholdInformation) &&
        Objects.equals(this.isRootCause, alarmMVO.isRootCause) &&
        Objects.equals(this.parentAlarm, alarmMVO.parentAlarm) &&
        Objects.equals(this.plannedOutageIndicator, alarmMVO.plannedOutageIndicator) &&
        Objects.equals(this.proposedRepairedActions, alarmMVO.proposedRepairedActions) &&
        Objects.equals(this.serviceAffecting, alarmMVO.serviceAffecting) &&
        Objects.equals(this.place, alarmMVO.place);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, href, id, externalAlarmId, state, alarmType, perceivedSeverity, probableCause, specificProblem, alarmedObjectType, alarmedObject, reportingSystemId, alarmDetails, alarmChangedTime, alarmClearedTime, alarmReportingTime, ackState, ackSystemId, ackUserId, affectedService, alarmEscalation, clearSystemId, clearUserId, comment, correlatedAlarm, crossedThresholdInformation, isRootCause, parentAlarm, plannedOutageIndicator, proposedRepairedActions, serviceAffecting, place);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AlarmMVO {\n");
