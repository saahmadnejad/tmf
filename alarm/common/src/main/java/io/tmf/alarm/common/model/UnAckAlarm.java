...
public class UnAckAlarm {
   ...
   */
  public UnAckAlarm(String atType) {
    this.atType = atType;
  }

  public UnAckAlarm atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public UnAckAlarm atBaseType(String atBaseType) {
  ...
  public UnAckAlarm atSchemaLocation(String atSchemaLocation) {
  ...
  public UnAckAlarm href(String href) {
    this.href = href;
    return this;
  }
  ...
  public UnAckAlarm id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UnAckAlarm state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public UnAckAlarm ackSystemId(String ackSystemId) {
  ...
  @Schema(name = "ackSystemId", description = "Name of the unacknowledging system", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public UnAckAlarm ackUserId(String ackUserId) {
  ...
  @Schema(name = "ackUserId", description = "Name of the unacknowledging user", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public UnAckAlarm ackTime(OffsetDateTime ackTime) {
  ...
  public UnAckAlarm alarmPattern(List<@Valid AlarmRefOrValue> alarmPattern) {
    this.alarmPattern = alarmPattern;
    return this;
  }

  public UnAckAlarm addAlarmPatternItem(AlarmRefOrValue alarmPatternItem) {
  ...
  public UnAckAlarm unAckedAlarm(List<@Valid AlarmRefOrValue> unAckedAlarm) {
    this.unAckedAlarm = unAckedAlarm;
    return this;
  }

  public UnAckAlarm addUnAckedAlarmItem(AlarmRefOrValue unAckedAlarmItem) {
  ...
  public boolean equals(Object o) {
    ...
    UnAckAlarm unAckAlarm = (UnAckAlarm) o;
    return Objects.equals(this.atType, unAckAlarm.atType) &&
        Objects.equals(this.atBaseType, unAckAlarm.atBaseType) &&
        Objects.equals(this.atSchemaLocation, unAckAlarm.atSchemaLocation) &&
        Objects.equals(this.href, unAckAlarm.href) &&
        Objects.equals(this.id, unAckAlarm.id) &&
        Objects.equals(this.state, unAckAlarm.state) &&
        Objects.equals(this.ackSystemId, unAckAlarm.ackSystemId) &&
        Objects.equals(this.ackUserId, unAckAlarm.ackUserId) &&
        Objects.equals(this.ackTime, unAckAlarm.ackTime) &&
        Objects.equals(this.alarmPattern, unAckAlarm.alarmPattern) &&
        Objects.equals(this.unAckedAlarm, unAckAlarm.unAckedAlarm);
  }
