...
import com.tmforum.alarm.model.AckAlarmCreateEventPayload;
...
public class AckAlarmCreateEvent {
  ...
  private AckAlarmCreateEventPayload event;

  public AckAlarmCreateEvent() {
    super();
  }
   ...
   */
  public AckAlarmCreateEvent(String atType) {
    this.atType = atType;
  }

  public AckAlarmCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AckAlarmCreateEvent atBaseType(String atBaseType) {
  ...
  public AckAlarmCreateEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public AckAlarmCreateEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public AckAlarmCreateEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AckAlarmCreateEvent correlationId(String correlationId) {
  ...
  public AckAlarmCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AckAlarmCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AckAlarmCreateEvent description(String description) {
  ...
  public AckAlarmCreateEvent priority(String priority) {
  ...
  public AckAlarmCreateEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public AckAlarmCreateEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public AckAlarmCreateEvent reportingSystem(EntityRef reportingSystem) {
  ...
  public AckAlarmCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public AckAlarmCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public AckAlarmCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public AckAlarmCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public AckAlarmCreateEvent eventId(String eventId) {
  ...
  public AckAlarmCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  public AckAlarmCreateEvent eventType(String eventType) {
  ...
  public AckAlarmCreateEvent event(AckAlarmCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public AckAlarmCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(AckAlarmCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    AckAlarmCreateEvent ackAlarmCreateEvent = (AckAlarmCreateEvent) o;
    return Objects.equals(this.atType, ackAlarmCreateEvent.atType) &&
        Objects.equals(this.atBaseType, ackAlarmCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, ackAlarmCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, ackAlarmCreateEvent.href) &&
        Objects.equals(this.id, ackAlarmCreateEvent.id) &&
        Objects.equals(this.correlationId, ackAlarmCreateEvent.correlationId) &&
        Objects.equals(this.domain, ackAlarmCreateEvent.domain) &&
        Objects.equals(this.title, ackAlarmCreateEvent.title) &&
        Objects.equals(this.description, ackAlarmCreateEvent.description) &&
        Objects.equals(this.priority, ackAlarmCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, ackAlarmCreateEvent.timeOccurred) &&
        Objects.equals(this.source, ackAlarmCreateEvent.source) &&
        Objects.equals(this.reportingSystem, ackAlarmCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, ackAlarmCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, ackAlarmCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, ackAlarmCreateEvent.eventId) &&
        Objects.equals(this.eventTime, ackAlarmCreateEvent.eventTime) &&
        Objects.equals(this.eventType, ackAlarmCreateEvent.eventType) &&
        Objects.equals(this.event, ackAlarmCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class AckAlarmCreateEvent {\n");
