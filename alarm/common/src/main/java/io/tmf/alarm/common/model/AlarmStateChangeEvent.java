...
import com.tmforum.alarm.model.AlarmStateChangeEventPayload;
...
public class AlarmStateChangeEvent {
  ...
  private AlarmStateChangeEventPayload event;

  public AlarmStateChangeEvent() {
    super();
  }
   ...
   */
  public AlarmStateChangeEvent(String atType) {
    this.atType = atType;
  }

  public AlarmStateChangeEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AlarmStateChangeEvent atBaseType(String atBaseType) {
  ...
  public AlarmStateChangeEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public AlarmStateChangeEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public AlarmStateChangeEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public AlarmStateChangeEvent reportingSystem(EntityRef reportingSystem) {
  ...
  public AlarmStateChangeEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public AlarmStateChangeEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public AlarmStateChangeEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public AlarmStateChangeEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, alarmStateChangeEvent.atType) &&
        Objects.equals(this.atBaseType, alarmStateChangeEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, alarmStateChangeEvent.atSchemaLocation) &&
        Objects.equals(this.href, alarmStateChangeEvent.href) &&
        Objects.equals(this.id, alarmStateChangeEvent.id) &&
        ...
        Objects.equals(this.timeOccurred, alarmStateChangeEvent.timeOccurred) &&
        Objects.equals(this.source, alarmStateChangeEvent.source) &&
        Objects.equals(this.reportingSystem, alarmStateChangeEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, alarmStateChangeEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, alarmStateChangeEvent.analyticCharacteristic) &&
