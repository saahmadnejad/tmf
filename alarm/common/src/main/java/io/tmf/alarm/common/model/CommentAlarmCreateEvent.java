...
import com.tmforum.alarm.model.CommentAlarmCreateEventPayload;
...
public class CommentAlarmCreateEvent {
  ...
  private CommentAlarmCreateEventPayload event;

  public CommentAlarmCreateEvent() {
    super();
  }
   ...
   */
  public CommentAlarmCreateEvent(String atType) {
    this.atType = atType;
  }

  public CommentAlarmCreateEvent atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CommentAlarmCreateEvent atBaseType(String atBaseType) {
  ...
  public CommentAlarmCreateEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public CommentAlarmCreateEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public CommentAlarmCreateEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CommentAlarmCreateEvent correlationId(String correlationId) {
  ...
  public CommentAlarmCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CommentAlarmCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CommentAlarmCreateEvent description(String description) {
  ...
  public CommentAlarmCreateEvent priority(String priority) {
  ...
  public CommentAlarmCreateEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public CommentAlarmCreateEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public CommentAlarmCreateEvent reportingSystem(EntityRef reportingSystem) {
  ...
  public CommentAlarmCreateEvent relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CommentAlarmCreateEvent addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  public CommentAlarmCreateEvent analyticCharacteristic(List<Characteristic> analyticCharacteristic) {
    this.analyticCharacteristic = analyticCharacteristic;
    return this;
  }

  public CommentAlarmCreateEvent addAnalyticCharacteristicItem(Characteristic analyticCharacteristicItem) {
  ...
  public CommentAlarmCreateEvent eventId(String eventId) {
  ...
  public CommentAlarmCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  public CommentAlarmCreateEvent eventType(String eventType) {
  ...
  public CommentAlarmCreateEvent event(CommentAlarmCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public CommentAlarmCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(CommentAlarmCreateEventPayload event) {
    this.event = event;
  }
  ...
  public boolean equals(Object o) {
    ...
    CommentAlarmCreateEvent commentAlarmCreateEvent = (CommentAlarmCreateEvent) o;
    return Objects.equals(this.atType, commentAlarmCreateEvent.atType) &&
        Objects.equals(this.atBaseType, commentAlarmCreateEvent.atBaseType) &&
        Objects.equals(this.atSchemaLocation, commentAlarmCreateEvent.atSchemaLocation) &&
        Objects.equals(this.href, commentAlarmCreateEvent.href) &&
        Objects.equals(this.id, commentAlarmCreateEvent.id) &&
        Objects.equals(this.correlationId, commentAlarmCreateEvent.correlationId) &&
        Objects.equals(this.domain, commentAlarmCreateEvent.domain) &&
        Objects.equals(this.title, commentAlarmCreateEvent.title) &&
        Objects.equals(this.description, commentAlarmCreateEvent.description) &&
        Objects.equals(this.priority, commentAlarmCreateEvent.priority) &&
        Objects.equals(this.timeOccurred, commentAlarmCreateEvent.timeOccurred) &&
        Objects.equals(this.source, commentAlarmCreateEvent.source) &&
        Objects.equals(this.reportingSystem, commentAlarmCreateEvent.reportingSystem) &&
        Objects.equals(this.relatedParty, commentAlarmCreateEvent.relatedParty) &&
        Objects.equals(this.analyticCharacteristic, commentAlarmCreateEvent.analyticCharacteristic) &&
        Objects.equals(this.eventId, commentAlarmCreateEvent.eventId) &&
        Objects.equals(this.eventTime, commentAlarmCreateEvent.eventTime) &&
        Objects.equals(this.eventType, commentAlarmCreateEvent.eventType) &&
        Objects.equals(this.event, commentAlarmCreateEvent.event);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommentAlarmCreateEvent {\n");
