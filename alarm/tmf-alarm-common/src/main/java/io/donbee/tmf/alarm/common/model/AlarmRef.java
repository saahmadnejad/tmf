...
public class AlarmRef implements AlarmRefOrValue {
   ...
   */
  public AlarmRef(String atType, String id) {
    this.atType = atType;
    this.id = id;
  }

  public AlarmRef atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public AlarmRef atBaseType(String atBaseType) {
  ...
  public AlarmRef atSchemaLocation(String atSchemaLocation) {
  ...
  public AlarmRef href(String href) {
    this.href = href;
    return this;
  }
  ...
  public AlarmRef name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AlarmRef atReferredType(String atReferredType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, alarmRef.atType) &&
        ...
        Objects.equals(this.id, alarmRef.id) &&
