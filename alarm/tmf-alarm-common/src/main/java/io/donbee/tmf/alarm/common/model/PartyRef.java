...
public class PartyRef implements PartyRefOrPartyRoleRef {
  ...
  public PartyRef atBaseType(String atBaseType) {
  ...
  public PartyRef atSchemaLocation(String atSchemaLocation) {
  ...
  public PartyRef atReferredType(String atReferredType) {
