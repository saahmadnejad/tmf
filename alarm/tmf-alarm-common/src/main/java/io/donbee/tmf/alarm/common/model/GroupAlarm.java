...
public class GroupAlarm {
   ...
   */
  public GroupAlarm(String atType) {
    this.atType = atType;
  }

  public GroupAlarm atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public GroupAlarm atBaseType(String atBaseType) {
  ...
  public GroupAlarm atSchemaLocation(String atSchemaLocation) {
  ...
  public GroupAlarm href(String href) {
    this.href = href;
    return this;
  }
  ...
  public GroupAlarm id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GroupAlarm state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public GroupAlarm sourceSystemId(String sourceSystemId) {
  ...
  public GroupAlarm alarmChangedTime(OffsetDateTime alarmChangedTime) {
   ...
   */
  @Valid 
  @Schema(name = "alarmChangedTime", description = "Time of the correlation", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public GroupAlarm parentAlarm(AlarmRefOrValue parentAlarm) {
  ...
  public GroupAlarm correlatedAlarm(List<@Valid AlarmRefOrValue> correlatedAlarm) {
    this.correlatedAlarm = correlatedAlarm;
    return this;
  }

  public GroupAlarm addCorrelatedAlarmItem(AlarmRefOrValue correlatedAlarmItem) {
  ...
  public GroupAlarm groupedAlarm(List<@Valid AlarmRefOrValue> groupedAlarm) {
    this.groupedAlarm = groupedAlarm;
    return this;
  }

  public GroupAlarm addGroupedAlarmItem(AlarmRefOrValue groupedAlarmItem) {
  ...
  public boolean equals(Object o) {
    ...
    GroupAlarm groupAlarm = (GroupAlarm) o;
    return Objects.equals(this.atType, groupAlarm.atType) &&
        Objects.equals(this.atBaseType, groupAlarm.atBaseType) &&
        Objects.equals(this.atSchemaLocation, groupAlarm.atSchemaLocation) &&
        Objects.equals(this.href, groupAlarm.href) &&
        Objects.equals(this.id, groupAlarm.id) &&
        Objects.equals(this.state, groupAlarm.state) &&
        Objects.equals(this.sourceSystemId, groupAlarm.sourceSystemId) &&
        Objects.equals(this.alarmChangedTime, groupAlarm.alarmChangedTime) &&
        Objects.equals(this.parentAlarm, groupAlarm.parentAlarm) &&
        Objects.equals(this.correlatedAlarm, groupAlarm.correlatedAlarm) &&
        Objects.equals(this.groupedAlarm, groupAlarm.groupedAlarm);
  }
